...
const sortLived = inventors.sort((a, b) => {
  let firstAge = a.passed - a.year;
  let secondAge = b.passed - b.year;
  firstAge > secondAge ? -1 : 1;
});
...
/*
      ...
      const links = [...catagory.querySelectorAll('a')];//converting nodeList to an array
      const de = links
